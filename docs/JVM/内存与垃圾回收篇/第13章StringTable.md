...
<img src="image/134-字符串常量池设置.png" alt="image-20200730132234031"  />
...
- 分析字符串常量池的变化
  ...
  ![image-20200730140509031](image/135-字符串常量池变化1.png)

  - 加载 换行符

  ![image-20200730140633063](image/136-字符串常量池变化2.png)

  - 加载了字符串常量 “1”~“9”

  ![image-20200730140720761](image/137-字符串常量池变化3.png)

  - 加载字符串常量 “10”

  ![image-20200730140849292](image/138-字符串常量池变化4.png)

  - 之后的字符串"1" 到 "10"不会再次加载

  ![image-20200730140916540](image/139-字符串常量池变化5.png)

  ![image-20200730140923967](image/140-字符串常量池变化6.png)
...
![image-20200730141106676](image/141-分析运行时内存方法.png)
...
![image-20200730144025877](image/142-字符串编译期优化.png)
...
**`toString()`方法和`new String("ab")`之间是约等于的关系，在后述中讲到**
...
![image-20200730145819502](image/143-字符串编译期优化.png)
...
![image-20200730213430075](image/144-intern字节码文件.png)
...
![image-20200730221929113](image/145-两种String创建剖析.png)
...
![image-20200730215914474](image/148-intern练习1jdk6.png)

- JDK 7/8 中：串池中没有创建字符串"ab"，而是创建一个引用，指向new String(“ab”)，将此引用返回

![image-20200730215945396](image/149-intern练习1jdk8.png)
...
![image-20200730221434699](image/150-intern练习2.png)
...
![image-20200730223548597](image/151-intern创建效率1.png)

- 使用 intern() 方法：由于数组中字符串的引用都指向字符串常量池中的字符串，所以程序需要维护的 String 对象更少，内存占用也更低

![image-20200730223500027](image/152-intern创建效率2.png)
