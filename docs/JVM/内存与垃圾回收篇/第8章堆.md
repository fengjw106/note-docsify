...
6. **从实际使用角度看的，“几乎”所有的对象实例都在这里分配内存。**因为还有一些对象是在栈上分配的（逃逸分析，标量替换）
...
<img src="image\61-jvisualvm工具.png"  />

- 查看进程1

<img src="image\62-工具查看进程.png"  />

- 查看进程2

<img src="image\63-工具查看进程1.png"  />

- 分别对应堆的新生区，养老区

<img src="image\64-堆的结构.png"  />
...
<img src="image\67-查看堆内存.png" alt="image-20200728213547918"  />
 ...
 * -Xmn:设置新生代的空间的大小。 （一般不设置） 如果和比例设置冲突，以此命令为主
 *
 * @author shkstart  shkstart@126.com
 * @create 2020  17:23
 */
...
<img src="image\79-TLAB分配过程.png" alt="image-20200707104253530"  />
...
<img src="image\80-TLAB默认状态.png" alt="image-20200729094733850"  />
...
<img src="image\81-未开启逃逸分析前.png" alt="image-20200729102928375"  />
...
<img src="E:\note\JVM\image\82-开启逃逸分析前.png" alt="image-20200729103126273" style="zoom:80%;" />
...
4. 据我所知，**Oracle Hotspot JVM中并未这么做**，这一点在逃逸分析相关的文档里已经说明，所以可以明确所有的对象实例都是创建在堆上。**而出现上述符合逃逸分析的结论是因为虽然没有使用逃逸分析，但是使用了标量替换。**
