...
![总体架构](image/image-20210624161158173.png)
...
![MySQL逻辑架构](image/20200801165252510.png)
...
![存储引擎](image/20200801170442428.png)
...
![image-20210624161422258](image/image-20210624161422258.png)

总结

![image-20210624161326817](image/image-20210624161326817.png)
...
从而可以获得索引的本质：<font color="red">**索引是排好序的快速查找数据结构。**</font>
...
**数据本身之外，数据库还维护这一个满足特定查找算法的数据结构，这些数据结构以某种方式指向数据，样就可以在这些数据结构的基础上实现高级查找算法。这种数据结构就是索引。**
