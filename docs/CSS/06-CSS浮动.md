...
1. 如何让多个盒子(div)水平排列成一行？
   ...
   ![03_水平排列div.png](image\03_水平排列div.png)

2. 如何实现盒子的左右对齐？

![float1.png](image\float1.png)
...
![01_文字环绕示意图.png](image\01_文字环绕示意图.png)
...
![24浮动一行显示.png](image\24浮动一行显示.png)
...
- 不会与父盒子的边框重叠，也不会超过父盒子的内边距
  ![05_父子盒子关系示意图.png](image\05_父子盒子关系示意图.png)
...
### 1). PS切片工具
 ...
 ![1498466173246](image/1498466173246.png)
...
* 利用辅助线 来切图 --    基于参考线的切片 
    ...
    ![1498466734205](image/1498466734205.png)
