...
**1. 小黄色块**在图片上移动，**吸引用户的眼球**。
 ...
 ![01_定位示例1.gif](image\01_定位示例1.gif)

![定位示例3](image\03_定位示例3.png)

**2. 当我们滚动窗口的时候，盒子是固定屏幕某个位置的**

![ding.png](image\ding.png)
...
2. **父元素没有定位**，则以**浏览器**为准定位（Document 文档）。
   ...
   ![05_绝对定位_父级无定位.png](image\05_绝对定位_父级无定位.png)

3. **父元素要有定位**
   
   * 将元素依据最近的已经定位（绝对、固定或相对定位）的父元素（祖先）进行定位。

![06_绝对定位_父级有定位.png](image\06_绝对定位_父级有定位.png)
...
![子绝父相截图](image\07_子绝父相截图.png)

![27子绝父相.png](image\27子绝父相.png)
...
![08_固定定位案例.png](image\08_固定定位案例.png)
...
![09_哈根达斯案例示意图.png](image\09_哈根达斯案例示意图.png)
...
![10_绝对定位水平居中.png](image\10_绝对定位水平居中.png)
...
![11_绝对定位居中示意图.png](image\11_绝对定位居中示意图.png)
...
![12_zindex示意图.png](image\12_zindex示意图.png)
